...
class CoTTA(nn.Module):
    def __init__(self, model, optimizer, cfg, episodic=False):
        super().__init__()
        self.model = model
...
def check_model(model):
    """Check model for compatability with CoTTA."""
    ...
    assert has_bn, "CoTTA needs normalization for its optimization"
